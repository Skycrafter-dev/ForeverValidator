// OptimizedCpu-only static collision traversal.
...
void CHmsCollisionManager::SZone::DetectCollisionsCorpusOptimizedCpu(
...
DetectCollisionBetweenTreeAndStaticCollisionTreeOptimizedCpu(
    ...
    for (u32 childIndex = 0; childIndex < childCount; childIndex++) {
        zone->DetectCollisionBetweenTreeAndStaticCollisionTreeOptimizedCpu(
            localIso,
    ...
    for (u32 staticTreeIndex = 0; staticTreeIndex < staticTreeCount;) {
        ...
        if (record->ContainsSurface() &&
            ...
            int surfaceCollisionResult =
                    CPlugSurface::ComputeCollisionOptimizedCpu(
                            surfacePair, *buffer);
